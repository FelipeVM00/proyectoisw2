...
public class ParqueaderoControlador implements Initializable{
    ...
    @FXML
    private JFXTreeTableView<?> tablaTotalAsignacionCarro;

    @FXML
    private TreeTableColumn<?, ?> tablaAsignacionCarro;

    @FXML
    private JFXTextField bucarAsignacionCarro;

    @FXML
    private TreeTableColumn<?, ?> numeroParqueoMoto;
    ...
    @FXML
    private JFXTreeTableView<?> tablaTotalAsignacionMoto;

    @FXML
    private TreeTableColumn<?, ?> tablaAsignacionesMoto;
